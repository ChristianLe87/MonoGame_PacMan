...
namespace Shared
{
    public class Inky : IGhosts
    {
        ...
        {
            this.point = /*point*/new Point(16, 14);
        ...
        public void Update()
        {
            ...
            if (framesCount == 20)
            {
                ...
                // 2 tiles infront of PacMan and then, rotate 180 degrees where Blinky is
                ...
                Blinky blinky = (Blinky)GameScene.ghosts.Where(x => x.ToString() == "Shared.Blinky").FirstOrDefault();
                Point blinkyPosition = blinky.point;

                // rotate 180 degrees where Blinky is
                playerPosition.X = playerPosition.X + (playerPosition.X - blinkyPosition.X);
                playerPosition.Y = playerPosition.Y + (playerPosition.Y - blinkyPosition.Y);
